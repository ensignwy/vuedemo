<template>
  <aside class="sidebar">
    <el-menu class="el-menu-vertical-demo" router="true" text-color="#000">
      <template v-for="item in menus">
        <template v-if="item.children">
          <el-submenu :index="item.id">
            <template slot="title"><i class="el-icon-menu"></i><span>{{item.title}}</span></template>
            <el-menu-item v-for="(child,i) in item.children" :key="i" :index="child.id" route="/manage">
        ...
        <template v-else>
          <el-menu-item :index="item.id" route="/manage">
            <i class="el-icon-menu"></i>
